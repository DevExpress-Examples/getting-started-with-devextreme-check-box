# Getting Started with DevExtreme jQuery CheckBox

This repository stores jQuery source code for the [Getting Started with CheckBox](https://js.devexpress.com/Documentation/Guide/UI_Components/CheckBox/Getting_Started_with_CheckBox/) tutorial.
